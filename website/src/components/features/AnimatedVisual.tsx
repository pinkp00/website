...
const bubbleItems = [
  {
    ...
    className: 'top-10 left-10 w-16 h-16',
  ...
  },
  {
    ...
    className: 'top-10 right-10 w-16 h-16',
  ...
  },
  {
    ...
    className: 'left-10 top-1/2 -translate-y-1/2 w-16 h-16',
  ...
  },
  {
    ...
    className: 'right-10 top-1/2 -translate-y-1/2 w-16 h-16',
  ...
  },
  {
    ...
    className: 'bottom-10 left-1/2 -translate-x-1/2 w-16 h-16',
  ...
  return (
    <div className="relative w-full overflow-visible px-4 lg:px-0">
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="relative w-[420px] h-[420px] rounded-full border border-violet-400/15 opacity-35" />
        <div className="absolute w-[420px] h-[420px] rounded-full border border-violet-300/25 border-dashed opacity-45" />
        <div className="absolute inset-0 animate-orbit-spin">
          <span className="absolute w-2.5 h-2.5 rounded-full bg-violet-300 opacity-95 shadow-[0_0_18px_rgba(148,163,255,0.45)]" style={{ left: '50%', top: '2%', transform: 'translateX(-50%)' }} />
          <span className="absolute w-2.5 h-2.5 rounded-full bg-violet-300 opacity-95 shadow-[0_0_18px_rgba(148,163,255,0.45)]" style={{ left: '50%', bottom: '2%', transform: 'translateX(-50%)' }} />
          <span className="absolute w-2.5 h-2.5 rounded-full bg-violet-300 opacity-95 shadow-[0_0_18px_rgba(148,163,255,0.45)]" style={{ left: '2%', top: '50%', transform: 'translateY(-50%)' }} />
          <span className="absolute w-2.5 h-2.5 rounded-full bg-violet-300 opacity-95 shadow-[0_0_18px_rgba(148,163,255,0.45)]" style={{ right: '2%', top: '50%', transform: 'translateY(-50%)' }} />
      ...
      <div className="relative mx-auto w-full max-w-[32${item.className} z-30`}>
              <div className={`w-full h-full flex items-center justify-center rounded-full bg-gradient-to-br ${item.bgColor} text-white/95 shadow-[0_20px_45px_rgba(0,0,0,0.18)] border border-white/10 backdrop-blur-sm`}>
                {item.icon}
              </div>
              <div className="absolute left-1/2 top-full mt-2 w-max -translate-x-1/2 text-[11px] font-medium text-white/80 tracking-[0.12em] uppercase">
